...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "basketball",
    price: 39.99,
    description: "Ballon de basketball orange avec une excellente prise en main et un rebond constant. Convient pour une utilisation en intérieur et en extérieur.",
  ...
  },
  {
    ...
    category: "tennis",
    price: 12.99,
    description: "Pack de 3 balles de tennis jaunes de haute qualité avec feutre durable et rebond uniforme. Approuvées pour les compétitions.",
  ...
  },
  {
    ...
    category: "clothing",
    price: 79.99,
    description: "Maillot officiel bleu et blanc de l'équipe nationale avec un tissu respirant et léger. Design authentique avec logo brodé.",
  ...
  },
  {
    ...
    category: "clothing",
    price: 69.99,
    description: "Maillot de basketball professionnel violet et jaune avec numéro, avec technologie d'évacuation de l'humidité. Coupe athlétique pour une liberté de mouvement maximale.",
  ...
  },
  {
    ...
    category: "football",
    price: 129.99,
    description: "Chaussures de football noires à crampons avec une excellente adhérence sur terrain naturel. Design léger pour une vitesse maximale.",
  ...
  },
  {
    ...
    category: "basketball",
    price: 149.99,
    description: "Chaussures de basketball high-top rouges avec un amorti supérieur et un excellent soutien de la cheville. Grip optimal pour des mouvements rapides.",
  ...
  },
  {
    ...
    category: "tennis",
    price: 119.99,
    description: "Chaussures de tennis blanches et bleues avec un confort exceptionnel et une stabilité latérale. Semelle adaptée pour tous types de courts.",
  ...
  },
  {
    ...
    category: "tennis",
    price: 199.99,
    description: "Raquette de tennis professionnelle bleue offrant puissance et contrôle. Cadre en graphite pour une durabilité maximale.",
    image: "https://placehold.co/800x800/e2e8f0/64748b?text=Raquette+de+Tennis",
    stock: 10
  },
  {
    id: 10,
    ...
    price: 49.99,
    description: "Sac de sport noir spacieux avec compartiments multiples. Idéal pour transporter tout votre équipement sportif.",
  ...
  },
  {
    ...
    category: "clothing",
    price: 34.99,
    description: "Short de football professionnel noir avec bandes blanches, léger et respirant avec une coupe ergonomique. Tissu qui évacue l'humidité pour rester au sec.",
  ...
  },
  {
    ...
    category: "accessories",
    price: 19.99,
    description: "Gourde sport bleue isolante qui maintient vos boissons fraîches pendant des heures. Design anti-fuite et facile à transporter.",
